        ...
        <div className="bg-white shadow-lg rounded-lg flex flex-row w-3/4 max-w-4xl">
          ...
          <div className="w-full md:w-1/2 p-8">
            ...
            <form className="space-y-4">
              <div>
                <TextField id="outlined-basic" name='name' type='text' label="Your name" variant="outlined" className='w-full' />
              </div>
              <div>
                <TextField id="outlined-basic" name='email' type='email' label="Email" variant="outlined" className='w-full' />
              </div>
