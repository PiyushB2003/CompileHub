...
export default function CustomizedSwitches() {
  ...
  // Effect to change document body background color based on theme
  useEffect(() => {
    document.body.style.backgroundColor = isDarkMode ? '#28252E' : '#ffffff'; // Your dark and light background colors
